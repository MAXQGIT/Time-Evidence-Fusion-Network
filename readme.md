...
只是在的run_config.py中加入了config路径而已。
作者源码https://github.com/ztxtech/Time-Evidence-Fusion-Network
数据下载链接
链接：https://pan.baidu.com/s/1Nb9dqjSKXkYN1E8Km8Fz4Q 
提取码：61au
Download data. You can obtain all the six benchmarks from [Tsinghua Cloud](https://cloud.tsinghua.edu.cn/d/e1ccfff39ad541908bae/) or [Google Drive](https://drive.google.com/drive/folders/1ZOYpTUa82_jCcxIdTmyr0LXQfvaM9vIy?usp=sharing). **All the datasets are well pre-processed** and can be used easily.